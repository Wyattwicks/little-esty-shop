...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe "Instance Methods" do
    describe '#discount_id' do
      it 'I get the ID of a discount that is applied to the invoice item' do
        merchant = create(:random_merchant, id: 22)
      ...
      it 'I do not get the ID of a discount that was not applied to the invoice item' do
        merchant = create(:random_merchant, id: 22)
        ...
        expect(invoice_item_1.discount_id).to_not eq(discount_2.id)
      end
    end
  end
end
